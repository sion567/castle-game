new Vue({
    ...
    template: `<div id="#app"> 
      ...
      <overlay v-if="activeOverlay">
        ...
        <overlay-content-player-turn v-else-if="activeOverlay === 'last-play'" :opponent="currentOpponent"/>
        <overlay-content-player-turn v-else-if="activeOverlay === 'game-over'" :players="players"/>
      </overlay>
    </div>`,
    methods: {
        handlePlay(){
